...
print "Usage: python run_all_postfits.py datacard_folder"
...
for signal_folder in signal_folders:
    ...
    limit_scripts = [limit_script for limit_script in os.listdir(".") if limit_script.endswith('_run_postfit.sh')]
